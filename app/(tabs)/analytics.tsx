...
import { Transaction, useTransactions } from '@/app/context/TransactionContext';
...
export default function StatisticsScreen() {
  ...
  const { 
    ...
    incomeData, 
    categoryData 
  } = processTransactionData(transactions, timeframe);
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.summaryRow}>
          <View style={[styles.summaryCard, styles.incomeCard]}>
            ...
            <Text style={styles.summaryValue}>${getTotalIncome().toFixed(2)}</Text>
          </View>
...
function processTransactionData(transactions: Transaction[], timeframe: string) {
  ...
  const now = new Date();
  let dataBuckets: Record<string, {expenses: number, income: number}> = {};
  let categoryBuckets: Record<string, number> = {};
